...
const reviews = [{
  ...
  img: "img/user1.jpg",
  name: "أحمد سعيد",
  text: "الاضافه سهلت عليا شغلي جدا وسريعه بشكل مش طبيعي."
}, {
  stars: 5,
  img: "img/user2.jpg",
  name: "منى عبدالله",
  text: "افضل حاجه اشتريتها الشهر ده، السعر مناسب جدا للجوده."
}, {
  stars: 5,
  img: "img/user3.jpg",
  name: "كريم فتحي",
  text: "تجربه ممتازه والدعم بيرد بسرعه لو في اي استفسار."
}, {
  stars: 5,
  img: "img/user4.jpg",
  name: "سارة يوسف",
  text: "التثبيت كان سهل جدا وواضح خطوه بخطوه."
}, {
  stars: 5,
  img: "img/user5.jpg",
  name: "محمود طارق",
  text: "بجد حاجه تستحق التجربه، هرشحها لأي حد بيدور علي حل زي كدا."
}, {
  stars: 5,
  img: "img/user6.jpg",
  name: "نور الهدى",
  text: "شغالة تمام على كل المتصفحات اللي جربتها."
}, {
  stars: 5,
  img: "img/user8.jpg",
  name: "محمد عبد الوهاب",
  text: "بجد شئ ممتاز و وفر عليا فلوس كتير بارك الله فيكم"
}, {
  stars: 3,
  img: "img/user9.jpg",
  name: "رامي عبد الله",
  text: "لحد دلوقتي كويسة و شغاله اتمني تفضل كدا بس بشكل عام جميله ماشاء الله"
}];
const faqs = [{
  q: "الاضافه دي شغاله على انهي متصفح؟",
  a: " Google Chrome, Microsoft Edge, Mozilla Firefox, Brave … واي متصفح مبني علي Chromium."
}, {
  q: "هل في دعم فني بعد الشراء؟",
  a: "اه طبعا، فريق الدعم موجود يساعدك في اي خطوه."
}, {
  q: "هل السعر شامل التحديثات؟",
  a: "اه، كل التحديثات المستقبليه متضمنه من غير اي تكلفه اضافيه."
}, {
  q: "هينفع استرجع فلوسي لو مكنتش عاجبني؟",
  a: "التفاصيل الكامله موجوده في صفحة شروط الاستخدام والخصوصيه."
}, {
  q: "الضمان؟",
  a: "ضمان تشغيل الإضافة بيستمر طول فترة الاشتراك أما بالنسبة لاسترجاع المبلغ فهو متاح خلال أول 10 أيام فقط يعني ببساطة إحنا بنضمن إن الإضافة تفضل شغالة معاك طول مدة الاشتراك ولو حصل أي مشكلة غير متوقعة وتوقفت الخدمة وكان اشتراكك لسه في أول 10 أيام هنرجعلك باقي المبلغ المستحق لكن لو فاتت الـ 10 أيام الاسترجاع مش بيكون متاح ومع ذلك إحنا بشكل مستمر بنقدّم تحديثات دورية عادة بتاخد من يوم إلى 3 أيام عمل كحد أقصى لضمان استمرار الخدمة بأفضل مستوى ولو لقدر الله ما قدرناش نوفر التحديث بيتم استرداد قيمة الاشتراك لو كنت لسه داخل فترة الضمان."
}, {
  q: "هل امان علي حسابي؟",
  a: "امان علي الحساب و في عملاء كتير بيتعاملو معانا و هي ملهاش اي علاقه بلحساب هي تعاملها فقط معا الشات"
}, {
  q: "هل الاضافه بتاخد وقت طويل عشان تتثبت؟",
  a: "لا، التثبيت بياخد اقل من دقيقتين لو اتبعت الخطوات اللي شفتها في الفيديو."
}, {
  q: "هل ينفع استخدمها على اكتر من جهاز؟",
  a: "جهاز واحد لان السريال بتاع المفتاح محفوظ علي"
}, {
  q: "سؤال اخر",
  a: "لو اسألتك مكنتش موجوده هنا تقدر تتواصل معا الدعم الفني"
}];
